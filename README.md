...
### 📊 仪表盘&主题切换
![白色主题](screenshots/theme-light.png)
![黑色主题](screenshots/theme-dark.png)
![红色主题](screenshots/theme-red.png)
...
### 🎬 EMBY 代理
![EMBY代理](screenshots/EMBYpproxy.png)
...
### 🎵 Navidrome 代理
![NAVIDROME](screenshots/navidromeproxy.png)
...
### 📁 文件管理
![文件管理](screenshots/filemanger.png)
- 本地文件系统浏览（列表视图，支持分页）
...
### 📝 STRM 规则
![STRM规则](screenshots/strmrule.png)
...
### 🎞️ 媒体整理
![媒体整理](screenshots/mtzl.png)
![评分洗版](screenshots/mexb.png)
![多版本洗版](screenshots/mtxb.png)
...
### 🚀 卫星任务（子项目dian115-s专用发布媒体）
![卫星发布](screenshots/zxm.png)
...
### 📢 资源中心
![资源中心](screenshots/zyzx.png)
![卫星资源](screenshots/wxzy.png)
![频道资源](screenshots/TGpdzy.png)
